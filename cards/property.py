...
class PropertyDarkBlueCard(PropertyCard):
    def __init__(self):
        super().__init__("Dark Blue", 4, "DARK_BLUE")

class PropertyBrownCard(PropertyCard):
    def __init__(self):
        super().__init__("Brown", 1, "BROWN")

class PropertyLightGreenCard(PropertyCard):
    def __init__(self):
        super().__init__("Light Green", 2, "LIGHT_GREEN")

class PropertyGreenCard(PropertyCard):
    def __init__(self):
        super().__init__("Green", 4, "GREEN")

class PropertyLightBlueCard(PropertyCard):
    def __init__(self):
        super().__init__("Light Blue", 2, "LIGHT_BLUE")

class PropertyOrangeCard(PropertyCard):
    def __init__(self):
        super().__init__("Orange", 2, "ORANGE")

class PropertyPurpleCard(PropertyCard):
    def __init__(self):
        super().__init__("Purple", 2, "PURPLE")

class PropertyRedCard(PropertyCard):
    def __init__(self):
        super().__init__("Red", 3, "RED")

class PropertyYellowCard(PropertyCard):
    def __init__(self):
        super().__init__("Yellow", 3, "YELLOW")

class PropertyBlackCard(PropertyCard):
    def __init__(self):
        super().__init__("Black", 2, "BLACK")

class JokerPropertyDarkBlueGreenCard(JokerPropertyCard):
    def __init__(self):
        super().__init__("Dark Blue/Green", 4, ["DARK_BLUE", "GREEN"])

class JokerPropertyBrownLightBlueCard(JokerPropertyCard):
    def __init__(self):
        super().__init__("Brown/Light Blue", 1, ["BROWN", "LIGHT_BLUE"])

class JokerPropertyPurpleOrangeCard(JokerPropertyCard):
    def __init__(self):
        super().__init__("Purple/Orange", 2, ["PURPLE", "ORANGE"])

class JokerPropertyRedYellowCard(JokerPropertyCard):
    def __init__(self):
        super().__init__("Red/Yellow", 3, ["RED", "YELLOW"])

class JokerPropertyBlackLightGreenCard(JokerPropertyCard):
    def __init__(self):
        super().__init__("Black/Light Green", 2, ["BLACK", "LIGHT_GREEN"])

class JokerPropertyBlackLightBlueCard(JokerPropertyCard):
    def __init__(self):
        super().__init__("Black/Light Blue", 4, ["BLACK", "LIGHT_BLUE"])

class JokerPropertyGreenBlackCard(JokerPropertyCard):
    def __init__(self):
        super().__init__("Green/Black", 4, ["GREEN", "BLACK"])

class JokerPropertyAllCard(JokerPropertyCard):
    def __init__(self):
        super().__init__("All", 0, ["DARK_BLUE", "BROWN", "LIGHT_GREEN", "GREEN", "LIGHT_BLUE", "ORANGE", "PURPLE", "RED", "YELLOW", "BLACK"])
